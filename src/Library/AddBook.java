    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getSource()==bt1)
        {
           try
           {
               ...
               String q1="insert into addbook(bookno,bookname,author,publisher,quantity,date) values('"+boookno+"','"+bookname+"','"+author+"','"+publisher+"','"+qty+"','"+date+"')";
               int x=obj.stm.executeUpdate(q1);
               if(x==1)
               {
